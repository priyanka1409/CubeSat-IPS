...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label3->Font = (gcnew System::Drawing::Font(L"Calibri", 9.75F, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->label3->Location = System::Drawing::Point(118, 103);
			this->label3->Name = L"label3";
			this->label3->Size = System::Drawing::Size(114, 15);
			this->label3->TabIndex = 6;
			this->label3->Text = L"GeoTiff Image Path:";
			// 
			// textBox2
			// 
			...
			this->button3->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 9.75F, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->button3->Location = System::Drawing::Point(269, 149);
			this->button3->Name = L"button3";
			this->button3->Size = System::Drawing::Size(147, 33);
			this->button3->TabIndex = 7;
			this->button3->Text = L"Make me a GeoTiff!";
			...
			this->ClientSize = System::Drawing::Size(680, 275);
...
#pragma endregion
	private: System::Void button1_Click(System::Object^  sender, System::EventArgs^  e) {
		...
		if (openFileDialog.ShowDialog() == System::Windows::Forms::DialogResult::OK) {
			...
			std::string objArg = msclr::interop::marshal_as< std::string >(openFileDialog.FileName);
...
private: System::Void button2_Click(System::Object^  sender, System::EventArgs^  e) {
	...
	if (openFileDialog.ShowDialog() == System::Windows::Forms::DialogResult::OK) {
		...
		std::string sceneArg = msclr::interop::marshal_as< std::string >(openFileDialog.FileName);
